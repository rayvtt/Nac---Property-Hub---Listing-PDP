# NAC Backlinks — Source of Truth

Canonical URLs for every NAC button, link, and asset across all PDPs. Source: NAC Backlinks spreadsheet (updated).

| Category | Type | Platform / Name | URL |
|----------|------|-----------------|-----|
| Website | Website Page | Blog | https://blog.nomadassetcollective.com |
| Website | Website Page | Main Website | https://nomadassetcollective.com |
| Social Media | Social Page | Instagram | https://instagram.com/nac.global |
| Social Media | Social Page | Threads | https://threads.net/@nac.global |
...
| UI element | Destination | URL |
|------------|-------------|-----|
| Header logo (light/dark variants) | Nomad home (Main Website) | https://nomadassetcollective.com |
...
| Footer · NAC PAGES col — Brochures | Brochures | https://nomadassetcollective.com/brochures |
